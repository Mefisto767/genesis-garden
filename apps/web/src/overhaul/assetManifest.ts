...
export const ASSET_MANIFEST: AssetManifestEntry[] = [
  ...
  },
  {
    ...
    group: 'paths_water_fences',
    source: { kind: 'file', path: 'assets/v1/environment/boundary_ruined_passage.png' },
    ...
    sortLayer: 'world-object',
    status: 'temporary',
    note: 'Starting Garden Visual Pack C: файловый арт заменяет серую процедурную заглушку; interaction/collision contract не меняется.',
  },
  {
    id: 'landmark_clearing',
    group: 'paths_water_fences',
    source: { kind: 'file', path: 'assets/v1/environment/landmark_monument.png' },
    purpose: 'Ботанический монумент в зарезервированном landmark_central (см. estateBlueprint.ts)',
    sizePx: [64, 64],
    frameCount: 1,
    anchor: [0.5, 0.5],
    collisionBox: null,
  ...
  // ---- buildings ------------------------------------------------------------
  {
    id: 'building_house',
    group: 'buildings',
    source: { kind: 'file', path: 'assets/v1/buildings/building_house.png' },
    purpose: 'Дом владельца — Gate 2 runtime candidate',
    sizePx: [128, 128],
    frameCount: 1,
    anchor: [0.5, 0.92],
    ...
    sortLayer: 'world-object',
    status: 'temporary',
    note: 'Отдельный прозрачный ассет из Starting Garden Gate 2. Не меняет slot/footprint; production approval — только после screenshot review.',
  },
  {
    id: 'building_lab',
    group: 'buildings',
    source: { kind: 'file', path: 'assets/v1/buildings/building_laboratory.png' },
    purpose: 'Здание лаборатории — Gate 2 runtime candidate',
    sizePx: [128, 128],
    frameCount: 1,
    anchor: [0.5, 0.92],
    ...
    sortLayer: 'world-object',
    status: 'temporary',
    note: 'Упрощённая версия style target для читаемости в 128×128. Координаты, interaction radius и footprint не менялись.',
  },
  {
  ...
  },
  {
    ...
    group: 'buildings',
    source: { kind: 'file', path: 'assets/v1/buildings/building_storage.png' },
    purpose: 'Небольшой склад стартового сада — Gate 2 runtime candidate',
    sizePx: [70, 70],
    frameCount: 1,
    anchor: [0.5, 0.92],
    ...
    sortLayer: 'world-object',
    status: 'temporary',
    note: 'Отдельный прозрачный ассет; slot, display box и collision contract сохранены.',
  },
  ...
  },
  {
    ...
    group: 'companion_lumi',
    source: { kind: 'file', path: 'assets/v1/buildings/lumi_station.png' },
    purpose: 'Станция Люми — Gate 2 runtime candidate',
    sizePx: [64, 80],
    frameCount: 1,
    anchor: [0.5, 0.92],
    collisionBox: null,
    ...
    sortLayer: 'world-object',
    status: 'temporary',
    note: 'Не блокирует движение намеренно. Только визуальная замена процедурной станции; поведение Люми не менялось.',
  },
